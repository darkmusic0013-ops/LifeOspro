...
export default function Home(){
  ...
  useEffect(() => {
    try {
      ...
      const savedFinance = window.localStorage.getItem(financeStorageKey);
      if(savedTasks) setTasks(JSON.parse(savedTasks));
      if(savedGoals) setGoals(JSON.parse(savedGoals));
      if(savedFinance) setFinance(JSON.parse(savedFinance));
    } catch {}
  }, []);
